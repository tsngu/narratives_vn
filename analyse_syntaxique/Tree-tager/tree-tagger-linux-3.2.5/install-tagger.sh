...
if [ -r tree-tagger-linux-3.2.5.tar.gz ]
then
    tar -zxf tree-tagger-linux-3.2.5.tar.gz
    echo 'TreeTagger version for PC-Linux installed.'
fi

if [ -r tree-tagger-MacOSX-Intel-3.2.3.tar.gz ]
then
    tar -zxf tree-tagger-MacOSX-Intel-3.2.3.tar.gz
    echo 'TreeTagger version for Mac OS-X (Intel) installed.'
fi

if [ -r tree-tagger-MacOSX-M1-3.2.3.tar.gz ]
then
    tar -zxf tree-tagger-MacOSX-M1-3.2.3.tar.gz
    echo 'TreeTagger version for Mac OS-X (M1) installed.'
fi
...
if [ -r belarusian.par.gz ] 
then
    gzip -cd belarusian.par.gz > lib/belarusian.par
    echo 'Belarusian parameter file installed.'
fi
...
then
    gzip -cd english-bnc.par.gz > lib/english-bnc.par
...
if [ -r albanian.par.gz ]
then
    gzip -cd albanian.par.gz > lib/albanian.par
    echo 'Albanian parameter file installed.'
fi
...
if [ -r ukrainian.par.gz ]
then
    gzip -cd ukrainian.par.gz > lib/ukrainian.par
    echo 'Ukrainian parameter file installed.'
fi

if [ -r indonesian.par.gz ]
then
    gzip -cd indonesian.par.gz > lib/indonesian.par
    echo 'Indonesian parameter file installed.'
fi
...
if [ -r tree-tagger-MacOSX-Intel-3.2.3.tar ]
then
    tar -xf tree-tagger-MacOSX-Intel-3.2.3.tar
    echo 'TreeTagger version for Mac OS-X (Intel) installed.'
fi

if [ -r tree-tagger-MacOSX-M1-3.2.3.tar ]
then
    tar -xf tree-tagger-MacOSX-M1-3.2.3.tar
    echo 'TreeTagger version for Mac OS-X (M1) installed.'
fi
...
if [ -r belarusian.par ] 
then
    mv belarusian.par lib/belarusian.par
    echo 'Belarusian parameter file installed.'
fi
...
then
    mv english-bnc.par lib/english-bnc.par
    echo 'English BNC parameter file installed.'
fi
...
if [ -r albanian.par ]
then
    mv albanian.par lib/albanian.par
    echo 'Albanian parameter file installed.'
fi
...
if [ -r ukrainian.par ]
then
    mv ukrainian.par lib/ukrainian.par
    echo 'Ukrainian parameter file installed.'
fi

if [ -r indonesian.par ]
then
    mv indonesian.par lib/indonesian.par
    echo 'Indonesian parameter file installed.'
fi
