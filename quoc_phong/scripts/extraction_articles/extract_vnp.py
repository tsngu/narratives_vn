...
def save_tokenization(contenu_tokenize, line_number):
    ...
    with open(f'../../output/vnp_mc/vnp_url_{line_number}.txt', 'w', encoding='utf-8') as file:
...
if __name__ == "__main__":
    ...
    pyLDAvis.save_html(lda_visu, '../../output/vnp_lda.html')
