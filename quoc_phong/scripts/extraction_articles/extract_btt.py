...
def save_tokenization(contenu_tokenize, line_number):
    ...
    with open(f'../../output/btt_mc/btt_url_{line_number}.txt', 'w', encoding='utf-8') as file:
...
if __name__ == "__main__":
    ...
    pyLDAvis.save_html(lda_visu, '../../output/btt_lda_mc.html')
